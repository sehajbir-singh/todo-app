      ...
      <div className=" md:container md:mx-auto bg-violet-100 rounded-2xl m-5 p-5 min-h-[70vh] md:w-1/2 ">
          ...
          <div className="flex">
            ...
            <span className="">
              <button
                ...
                className="bg-violet-400 gap-4 disabled:bg-gray-400 cursor-pointer enabled:hover:shadow-2xl enabled:dark:bg-surface-dark hover:bg-violet-800 p-3 py-1 rounded-3xl text-sm text-white font-bold transition-all duration-100 m-5"
              >
                Save
              </button>
            </span>
        ...
        <div className="flex items-center ps-4 bg-neutral-primary-soft border border-gray-400 rounded-xl shadow-md p-2 m-5">
          <input
            ...
            className="my-3 mx-3 w-4 h-4 focus:ring-2 focus:ring-brand-soft focus:ring-blue-300 "
          />{" "}
          Show finished.
        </div>
          ...
          {todos.map((item) => {
            return (
              (showfinished || !item.isCompleted) && (
                <div
                  key={item.id}
                  className="todo flex flex-row m-2 md:w-1/2 justify-between"
                >
